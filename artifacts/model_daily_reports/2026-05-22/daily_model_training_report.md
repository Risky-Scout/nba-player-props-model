# Daily model training / recalibration report — 2026-05-22

- generated_at_utc: 2026-05-23T16:36:46+00:00Z
...
- expected_today_challenger_id: `challenger-2026-05-22`
- active_champion_model_id: `challenger-2026-04-30`
- promotion_reason: `gate_failed:m6_3_stat_role_matrix_valid`
- decision_id: `None`
- decided_at_utc: `None`
...
{
  "outcome": "pending",
  "blocker": "no after-game scoring summary found for as_of_date=2026-05-22"
}
```
...
{
  "outcome": "pending",
  "blocker": "no rolling Derek benchmark found for as_of_date=2026-05-22"
}
```
...
- Latest study: https://github.com/Risky-Scout/nba-player-props-model/blob/main/artifacts/experience_studies/pmf_variance_experience_2026-05-22.md
