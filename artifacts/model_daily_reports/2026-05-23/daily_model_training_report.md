# Daily model training / recalibration report — 2026-05-23

- generated_at_utc: 2026-05-24T14:12:49+00:00Z
...
- manifest_promoted_field: `False`
- champion_pointer_swapped_to_today: **False**
- expected_today_challenger_id: `challenger-2026-05-23`
- active_champion_model_id: `challenger-2026-04-30`
- promotion_reason: `gate_failed:m6_3_stat_role_matrix_valid`
- decision_id: `None`
- decided_at_utc: `None`
...
{
  "outcome": "pending",
  "blocker": "no after-game scoring summary found for as_of_date=2026-05-23"
}
```
...
{
  "outcome": "pending",
  "blocker": "no rolling Derek benchmark found for as_of_date=2026-05-23"
}
```
