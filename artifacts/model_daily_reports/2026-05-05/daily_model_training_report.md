# Daily model training / recalibration report — 2026-05-05

- generated_at_utc: 2026-05-06T17:05:31+00:00Z
...
- expected_today_challenger_id: `challenger-2026-05-05`
- active_champion_model_id: `challenger-2026-04-30`
- promotion_reason: `gate_failed:promotion_clock_safe`
- decision_id: `None`
- decided_at_utc: `None`
...
{
  "outcome": "pending",
  "blocker": "no after-game scoring summary found for as_of_date=2026-05-05"
}
```
...
{
  "outcome": "pending",
  "blocker": "no rolling Derek benchmark found for as_of_date=2026-05-05"
}
```
...
- Latest study: https://github.com/Risky-Scout/nba-player-props-model/blob/main/artifacts/experience_studies/pmf_variance_experience_2026-05-05.md
