# Daily model training / recalibration report — 2026-05-09

- generated_at_utc: 2026-05-10T22:16:39+00:00Z
...
- expected_today_challenger_id: `challenger-2026-05-09`
- active_champion_model_id: `challenger-2026-04-30`
- promotion_reason: `gate_failed:promotion_clock_safe`
- decision_id: `None`
- decided_at_utc: `None`
...
{
  "outcome": "pending",
  "blocker": "no after-game scoring summary found for as_of_date=2026-05-09"
}
```
...
{
  "outcome": "pending",
  "blocker": "no rolling Derek benchmark found for as_of_date=2026-05-09"
}
```
