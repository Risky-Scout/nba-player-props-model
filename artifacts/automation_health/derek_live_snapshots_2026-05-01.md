...
| 21681995/t_minus_25/lineup_blocker_documented | yes | lineup_blocker='no confirmed lineup source wired (Phase 13L Part E acknowledged blocker; role_bucket is derived from projected minutes).' |
...
| 21681996/t_minus_25/lineup_blocker_documented | yes | lineup_blocker='no confirmed lineup source wired (Phase 13L Part E acknowledged blocker; role_bucket is derived from projected minutes).' |
...
| 21684812/t_minus_25/lineup_blocker_documented | yes | lineup_blocker='no confirmed lineup source wired (Phase 13L Part E acknowledged blocker; role_bucket is derived from projected minutes).' |
