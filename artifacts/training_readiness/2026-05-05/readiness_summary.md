# Daily Training Readiness — 2026-05-05

| Field | Value |
| --- | --- |
| Generated (UTC) | 2026-05-06T22:27:37+00:00 |
| Code commit | d0c3fca35577 |
| Overall pass | yes |
| Blocking failed | 0 |
| Advisory failed | 2 |
...
| --- | --- | --- | --- |
| outcomes_through_as_of_date | blocking | yes | rows through 2026-05-05: 83821 |
| future_dates_present_advisory | advisory | yes | 0 rows have date > 2026-05-05; trainer must filter them out |
...
| min_training_rows | blocking | yes | 83821 >= 5000 |
| min_per_stat_rows | advisory | yes | enough=['pts', 'reb', 'ast', 'fg3m', 'stl', 'blk'] thin=[] |
| no_duplicate_player_game_rows_on_date | blocking | yes | 0 duplicates on 2026-05-05 |
...
```
{
  "player_game_stats_total_rows": 83821,
  "player_game_stats_rows_through_as_of": 83821,
