...
| Field | Value |
| --- | --- |
| Generated (UTC) | 2026-05-23T22:31:40+00:00 |
| Promote | no |
...
- nll_improves_or_non_worse: challenger=1.69806 champion=1.69806 delta=+0 (tol=0.016980568570555216)
- rps_improves_or_non_worse: challenger=0.949653 champion=0.949653 delta=+0 (tol=0.009496525881099676)
- calibration_error_improves: challenger=0.316956 champion=0.316956 delta=+0 (tol=0.0)
- p0_error_improves_or_non_worse: challenger=0.316956 champion=0.316956 delta=+0 (tol=0.005)
- mean_bias_does_not_worsen: challenger=0.0683154 champion=0.0683154 delta=+0 (tol=0.05)
- tov_does_not_regress: challenger=1.28499 champion=1.28499 delta=+0 (tol=0.025699714274400556)
