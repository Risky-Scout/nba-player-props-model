...
| Check | Pass | Detail |
| --- | --- | --- |
| fold_aggregate_max_game_date | yes | max=2026-03-03 cutoff=2026-05-09 source=fold_aggregate.parquet |
...
| training_inputs_no_future_rows | yes | rows_after_cutoff=124368 future_rows_excluded=0 |

## Max dates seen

```
{
  "fold_aggregate": "2026-03-03",
  ...
  "prepare_fold_aggregate_rows_after_cutoff": 124368,
