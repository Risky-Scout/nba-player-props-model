...
@pytest.mark.xfail(
    strict=False,
    reason=(
        "SGP price grid (sgp_price_grid.parquet) is not yet generated by the pipeline. "
        "This test will pass once price_sgp_ticket.py / run_sgp_engine_daily.py "
        "writes a price grid file as part of the daily output."
    ),
)
