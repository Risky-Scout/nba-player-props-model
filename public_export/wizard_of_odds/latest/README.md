# Wizard of Odds — 2026-05-01

## Run status — 2026-05-01 — snapshot `pre_close`
...
- role provenance: `derived_from_projected_minutes`: 95
- model: `2d6f340#phase10c`
...
- **role_freshness_status (rollup)**: `{'derived_from_projected_minutes': 95}`
- **tov_status**: `missing_from_prediction_source`
- **row counts**: fair_odds_board=2519, full_pmfs_wide=95, market_comparison=1372, publishable_edges=1291
