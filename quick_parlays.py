...
# Load predictions
df = pd.read_csv('predictions/tonight_20251114.csv')
...
pd.DataFrame(sgp2).sort_values('prob', ascending=False).head(200).to_csv('predictions/top_200_sgp2_20251114.csv', index=False)
...
pd.DataFrame(sgp3).sort_values('prob', ascending=False).head(200).to_csv('predictions/top_200_sgp3_20251114.csv', index=False)
...
pd.DataFrame(cross2).sort_values('prob', ascending=False).head(200).to_csv('predictions/top_200_cross2_20251114.csv', index=False)
...
pd.DataFrame(cross3).sort_values('prob', ascending=False).head(200).to_csv('predictions/top_200_cross3_20251114.csv', index=False)

print("✅ ALL 5 FILES CREATED!")
