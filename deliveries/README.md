# Deliveries
_Index regenerated 2026-05-02T23:08:24Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-02** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 29 | 660 | 386 | 287 | `full` | `fresh` | `missing_from_prediction_source` | `incomplete` | — | `present` | 379 | `n/a` | `6eb011b#phase10c` |
