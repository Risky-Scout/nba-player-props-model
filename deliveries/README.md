# Deliveries
_Index regenerated 2026-05-04T19:55:06Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-04** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 65 | 1724 | 979 | 801 | `full` | `fresh` | `missing_from_prediction_source` | `absent` | — | `—` | — | `n/a` | `9688166#phase10c` |
