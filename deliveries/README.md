# Deliveries
_Index regenerated 2026-05-15T03:33:19Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-15** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 792 | 16962 | 4831 | 3634 | `full` | `fresh` | `present` | `morning_present` | 5196 | `—` | 5196 | `pending_outcomes` | `fa242168#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=5196 · latest→morning
