# Deliveries
_Index regenerated 2026-05-08T23:53:50Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-08** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 335 | 7839 | 1639 | 1111 | `full` | `fresh` | `present` | `incomplete` | — | `present` | 1847 | `n/a` | `4b2e5bde#phase10c` |
