# Deliveries
_Index regenerated 2026-05-21T17:41:14Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-21** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 180 | 3855 | 2515 | 1931 | `full` | `fresh` | `present` | `morning_present` | 2474 | `pending_pre_tipoff_run` | 2474 | `n/a` | `8ee6dd7e#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2474 · lineup=pending_pre_tipoff_run · latest→morning
