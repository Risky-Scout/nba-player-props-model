# Deliveries
_Index regenerated 2026-05-01T23:35:24Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-01** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 95 | 2519 | 1202 | 1142 | `full` | `fresh` | `missing_from_prediction_source` | `incomplete` | — | `present` | 1199 | `n/a` | `f496f12#phase10c` |
