# Deliveries
_Index regenerated 2026-05-01T20:44:07Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-01** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 95 | 2519 | 1547 | 1476 | `full` | `fresh` | `missing_from_prediction_source` | `absent` | — | `—` | — | `n/a` | `a3560d8#phase10c` |
