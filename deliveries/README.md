# Deliveries
_Index regenerated 2026-05-20T13:03:08Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-20** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 156 | 3341 | 2275 | 1831 | `full` | `fresh` | `present` | `morning_present` | 2229 | `pending_pre_tipoff_run` | 2229 | `n/a` | `50757ad1#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2229 · lineup=pending_pre_tipoff_run · latest→morning
