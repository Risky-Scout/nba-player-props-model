# Deliveries
_Index regenerated 2026-05-01T16:03:20Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-01** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 95 | 2519 | 1528 | 1472 | `full` | `fresh` | `missing_from_prediction_source` | `absent` | — | `—` | — | `n/a` | `4cb9286#phase10c` |
