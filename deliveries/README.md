# Deliveries
_Index regenerated 2026-05-18T16:54:44Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-18** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 180 | 3855 | 2520 | 2044 | `full` | `fresh` | `present` | `morning_present` | 2471 | `pending_pre_tipoff_run` | 2471 | `n/a` | `992f1ee6#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2471 · lineup=pending_pre_tipoff_run · latest→morning
