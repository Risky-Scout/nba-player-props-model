# Deliveries
_Index regenerated 2026-06-05T17:27:50Z by `scripts/build_deliveries_index.py`._
...
| **2026-06-05** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 192 | 4112 | 2729 | 2160 | `full` | `fresh` | `present` | `morning_present` | 2679 | `pending_pre_tipoff_run` | 2679 | `n/a` | `a987002b#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2679 · lineup=pending_pre_tipoff_run · latest→morning
