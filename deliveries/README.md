# Deliveries
_Index regenerated 2026-05-20T17:54:23Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-20** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 156 | 3341 | 2377 | 1902 | `full` | `fresh` | `present` | `morning_present` | 2326 | `pending_pre_tipoff_run` | 2326 | `n/a` | `b49eade0#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2326 · lineup=pending_pre_tipoff_run · latest→morning
