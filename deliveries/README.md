# Deliveries
_Index regenerated 2026-05-01T19:24:40Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-01** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 95 | 2519 | 1545 | 1480 | `full` | `fresh` | `missing_from_prediction_source` | `absent` | — | `—` | — | `n/a` | `834b2c2#phase10c` |
