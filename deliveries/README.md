# Deliveries
_Index regenerated 2026-05-04T16:54:18Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-04** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 65 | 1724 | 954 | 834 | `full` | `fresh` | `missing_from_prediction_source` | `absent` | — | `—` | — | `n/a` | `466c26c#phase10c` |
