# Deliveries
_Index regenerated 2026-06-08T18:04:19Z by `scripts/build_deliveries_index.py`._
...
| **2026-06-08** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 144 | 3084 | 2338 | 1929 | `full` | `fresh` | `present` | `morning_present` | 2278 | `pending_pre_tipoff_run` | 2278 | `n/a` | `9ee5dc2c#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2278 · lineup=pending_pre_tipoff_run · latest→morning
