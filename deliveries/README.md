# Deliveries
_Index regenerated 2026-05-18T22:48:14Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-18** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 180 | 3855 | 2544 | 2064 | `full` | `fresh` | `present` | `morning_present` | 2494 | `pending_pre_tipoff_run` | 2494 | `n/a` | `c931b24d#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2494 · lineup=pending_pre_tipoff_run · latest→morning
