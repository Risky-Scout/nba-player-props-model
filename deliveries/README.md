# Deliveries
_Index regenerated 2026-05-05T03:51:14Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-04** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 65 | 1724 | 0 | 0 | `none` | `fresh` | `missing_from_prediction_source` | `incomplete` | — | `present` | 65 | `n/a` | `c74808d#phase10c` |
