# Deliveries
_Index regenerated 2026-06-08T18:10:16Z by `scripts/build_deliveries_index.py`._
...
| **2026-06-08** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 144 | 3084 | 2351 | 1905 | `full` | `fresh` | `present` | `morning_present` | 2291 | `pending_pre_tipoff_run` | 2291 | `n/a` | `2a5a7aa6#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2291 · lineup=pending_pre_tipoff_run · latest→morning
