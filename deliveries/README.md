# Deliveries
_Index regenerated 2026-05-06T19:55:44Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-06** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 111 | 2364 | 1224 | 1181 | `full` | `fresh` | `present` | `absent` | — | `—` | — | `n/a` | `84d6db3#phase10c` |
