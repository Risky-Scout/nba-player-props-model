# Deliveries
_Index regenerated 2026-05-16T22:43:38Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-17** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 168 | 3598 | 2036 | 1637 | `full` | `fresh` | `present` | `morning_present` | 2011 | `pending_pre_tipoff_run` | 2011 | `n/a` | `961e3133#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2011 · lineup=pending_pre_tipoff_run · latest→morning
