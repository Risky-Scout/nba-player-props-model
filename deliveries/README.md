# Deliveries
_Index regenerated 2026-05-18T16:14:51Z by `scripts/build_deliveries_index.py`._
...
| **2026-05-18** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 180 | 3855 | 2521 | 2112 | `full` | `fresh` | `present` | `morning_present` | 2472 | `pending_pre_tipoff_run` | 2472 | `n/a` | `f02a69a0#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2472 · lineup=pending_pre_tipoff_run · latest→morning
