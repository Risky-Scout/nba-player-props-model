# Deliveries
_Index regenerated 2026-06-05T15:56:10Z by `scripts/build_deliveries_index.py`._
...
| **2026-06-05** | `PROVISIONAL_DELIVERABLE_READY_WITH_WARNINGS` | 192 | 4112 | 2726 | 2178 | `full` | `fresh` | `present` | `morning_present` | 2676 | `pending_pre_tipoff_run` | 2676 | `n/a` | `c86867fd#phase10c` |
...
**Derek forward feed (PMF snapshots)** — morning rows=2676 · lineup=pending_pre_tipoff_run · latest→morning
