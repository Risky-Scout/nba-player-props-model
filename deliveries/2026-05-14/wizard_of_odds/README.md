# Wizard of Odds — 2026-05-14

## Run status — 2026-05-14 — snapshot `morning`
...
- role provenance: no role signal
- model: `8611c657#phase10c`
...
- `target_stats_mismatch` — missing=['ast', 'blk', 'fg3m', 'pa', 'pr', 'pra', 'pts', 'ra', 'reb', 'stl', 'stocks', 'tov']; extra_relative_to_supported=[]
...
- **finality_blockers**: `['injury_very_stale', 'target_stats_mismatch', 'lineup_unconfirmed']`
...
- **role_freshness_status (rollup)**: `{}`
- **tov_status**: `missing_from_prediction_source`
- **row counts**: fair_odds_board=0, full_pmfs_wide=0, market_comparison=0, publishable_edges=0
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 0, 'fair_under_odds_null_count': 0, 'zero_or_one_prob_count': 0}`
