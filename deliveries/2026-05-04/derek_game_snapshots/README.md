# Derek PMF Snapshots — May 4, 2026
...
_Game ID `21707972` (used in paths only). Tip time UTC: `2026-05-05T01:43:12Z`._

- **T-minus-25**: Pending dispatch
- **Close-lock** (Missed during setup window; documented, not backfilled):
  - [missed_snapshot_report.md](21707972/close_lock/missed_snapshot_report.md)

### 76ers @ Knicks

_Game ID `21708671` (used in paths only). Tip time UTC: `2026-05-05T00:13:39Z`._

- **T-minus-25** (Missed during setup window; documented, not backfilled):
  - [missed_snapshot_report.md](21708671/t_minus_25/missed_snapshot_report.md)
- **Close-lock** (Missed during setup window; documented, not backfilled):
  - [missed_snapshot_report.md](21708671/close_lock/missed_snapshot_report.md)
