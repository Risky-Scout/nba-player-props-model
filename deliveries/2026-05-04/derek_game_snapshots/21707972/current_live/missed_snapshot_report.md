# Timberwolves @ Spurs — Current-live snapshot
...
- Home Team: Spurs
- Snapshot type: `current_live`
- Target time UTC: `None`
- Tip time UTC: `None`
- Documented at UTC: `None`
- Missed reason: `Daily current_live workflow did not produce a production_live snapshot for this game today. Documented historical miss; not a fabricated pre-tip snapshot. Subsequent days' workflow will publish current_live in the morning window.`
