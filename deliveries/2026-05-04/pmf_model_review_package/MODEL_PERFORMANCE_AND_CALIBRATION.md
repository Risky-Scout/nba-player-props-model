# Model performance & calibration — 2026-05-04

**after_game_status**: `pending_outcomes`

This file will be re-written by `scripts/score_daily_pmf_delivery_after_game.py` once box-score finals are loaded into `data/player_game_stats.parquet` for 2026-05-04.

## Rollup at delivery time

- delivery_date: `2026-05-04`
- props in delivery: **65**
- finality_status: `provisional`
- finality_blockers: market_coverage_none, lineup_unconfirmed, missing_stats:tov
- model_version: `c74808d#phase10c`
