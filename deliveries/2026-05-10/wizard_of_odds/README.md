# Wizard of Odds — 2026-05-10

## Run status — 2026-05-10 — snapshot `after_game`
...
- role provenance: `derived_from_projected_minutes`: 816
...
- **role_freshness_status (rollup)**: `{'derived_from_projected_minutes': 816}`
- **tov_status**: `present`
- **row counts**: fair_odds_board=17476, full_pmfs_wide=816, market_comparison=4620, publishable_edges=0
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 2580, 'fair_under_odds_null_count': 2580, 'zero_or_one_prob_count': 1477}`
