# Wizard of Odds — 2026-05-05

## Run status — 2026-05-05 — snapshot `after_game`
...
- role provenance: `derived_from_projected_minutes`: 840
...
- **role_freshness_status (rollup)**: `{'derived_from_projected_minutes': 840}`
- **tov_status**: `present`
- **row counts**: fair_odds_board=17990, full_pmfs_wide=840, market_comparison=4148, publishable_edges=0
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 2736, 'fair_under_odds_null_count': 2736, 'zero_or_one_prob_count': 1463}`
