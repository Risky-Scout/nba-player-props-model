# Model performance & calibration — 2026-04-29

**after_game_status**: `pending_outcomes`

This file will be re-written by `scripts/score_daily_pmf_delivery_after_game.py` once box-score finals are loaded into `data/player_game_stats.parquet` for 2026-04-29.

## Rollup at delivery time

- delivery_date: `2026-04-29`
- props in delivery: **104**
- finality_status: `provisional`
- finality_blockers: injury_very_stale, lineup_unconfirmed, missing_stats:tov
- model_version: `bb723eb#phase10c`
