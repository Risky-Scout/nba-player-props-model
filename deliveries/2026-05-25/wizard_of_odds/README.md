...
- **tov_status**: `present`
- **row counts**: fair_odds_board=3084, full_pmfs_wide=144, market_comparison=2254, publishable_edges=1743
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 411, 'fair_under_odds_null_count': 411, 'zero_or_one_prob_count': 240}`
