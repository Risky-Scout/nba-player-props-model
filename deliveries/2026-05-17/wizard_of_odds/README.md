...
- **tov_status**: `present`
- **row counts**: fair_odds_board=3598, full_pmfs_wide=168, market_comparison=2260, publishable_edges=1833
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 523, 'fair_under_odds_null_count': 523, 'zero_or_one_prob_count': 280}`
