# Model performance & calibration — 2026-04-28

**after_game_status**: `pending_outcomes`

This file will be re-written by `scripts/score_daily_pmf_delivery_after_game.py` once box-score finals are loaded into `data/player_game_stats.parquet` for 2026-04-28.

## Rollup at delivery time

- delivery_date: `2026-04-28`
- props in delivery: **1260**
- finality_status: `final`
- finality_blockers: _none_
- model_version: `5c9c8e3a#phase10c`
