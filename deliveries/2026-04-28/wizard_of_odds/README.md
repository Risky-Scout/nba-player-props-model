# Wizard of Odds — 2026-04-28

## Run status — 2026-04-28 — snapshot `after_game`
...
- role provenance: `derived_from_projected_minutes`: 1260
...
- **role_freshness_status (rollup)**: `{'derived_from_projected_minutes': 1260}`
- **tov_status**: `present`
- **row counts**: fair_odds_board=26985, full_pmfs_wide=1260, market_comparison=7080, publishable_edges=0
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 4069, 'fair_under_odds_null_count': 4069, 'zero_or_one_prob_count': 2262}`
