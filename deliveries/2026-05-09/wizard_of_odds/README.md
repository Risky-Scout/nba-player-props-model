...
## Run status — 2026-05-09 — snapshot `morning`
...
- **tov_status**: `present`
- **row counts**: fair_odds_board=8073, full_pmfs_wide=345, market_comparison=2306, publishable_edges=1700
