# Wizard of Odds — 2026-05-09

## Run status — 2026-05-09 — snapshot `pre_close`
...
- **tov_status**: `present`
- **row counts**: fair_odds_board=8073, full_pmfs_wide=345, market_comparison=1958, publishable_edges=1418
