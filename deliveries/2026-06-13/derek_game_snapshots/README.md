...
_Game ID `21716138` (used in paths only). Tip time UTC: `2026-06-14T00:40:00Z`._

- **Current-live** (Available):
  - [snapshot_report.md](21716138/current_live/snapshot_report.md)
  - [market_comparison.csv](21716138/current_live/market_comparison.csv)
  - [full_pmf_wide.csv](21716138/current_live/full_pmf_wide.csv)
  - [outcome_level_probabilities.csv](21716138/current_live/outcome_level_probabilities.csv)
