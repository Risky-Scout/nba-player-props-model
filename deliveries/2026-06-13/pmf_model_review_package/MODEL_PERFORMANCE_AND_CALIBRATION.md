# Model performance & calibration — 2026-06-13

**after_game_status**: `pending_outcomes`

This file will be re-written by `scripts/score_daily_pmf_delivery_after_game.py` once box-score finals are loaded into `data/player_game_stats.parquet` for 2026-06-13.
...
- model_version: `81503445#phase10c`
