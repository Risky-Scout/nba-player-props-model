# Lineup / injury / game-context impact — 2026-06-03 game 21716134 (close_lock)
...
- official_lineup_context_supplied: **False**
- injury_context_supplied: **True**
- game_context_supplied: **True**
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Victor Wembanyama | reb | UNDER | 11.500 | fanduel | 0.773 | 0.477 | +0.298 | +0.585 | REVIEW_LARGE_EDGE | line_vs_median_gap | CALIBRATION_SAMPLE_LIMITED | abs_edge_>=_20pp; calibration sample limited (n=53) |
...
| Victor Wembanyama | pts | UNDER | 26.500 | fanatics | 0.741 | 0.486 | +0.258 | +0.467 | PUBLISH_BLOCKER | line_vs_median_gap | CALIBRATION_SUPPORTED | calculation_bug |
| Stephon Castle | ast | UNDER | 6.500 | draftkings | 0.673 | 0.453 | +0.221 | +0.446 | REVIEW_LARGE_EDGE | line_vs_median_gap | CALIBRATION_SAMPLE_LIMITED | abs_edge_>=_20pp; calibration sample limited (n=97) |
...
| Luke Kornet | reb | UNDER | 2.500 | draftkings | 0.675 | 0.468 | +0.209 | +0.404 | REVIEW_LARGE_EDGE | market_prob_disagreement | CALIBRATION_SAMPLE_THIN | abs_edge_>=_20pp; calibration CALIBRATION_SAMPLE_THIN (n=12) |
...
| Julian Champagnie | reb | UNDER | 5.500 | fanduel | 0.696 | 0.512 | +0.185 | +0.329 | ACTIONABLE_REVIEWED | line_vs_median_gap | CALIBRATION_SUPPORTED | passes_all_gates |
...
| Stephon Castle | reb | UNDER | 4.500 | fanduel | 0.607 | 0.452 | +0.157 | +0.311 | ACTIONABLE_REVIEWED | market_prob_disagreement | CALIBRATION_SUPPORTED | passes_all_gates |
| Karl-Anthony Towns | pts | UNDER | 16.500 | fanduel | 0.653 | 0.505 | +0.150 | +0.269 | ACTIONABLE_REVIEWED | line_vs_median_gap | CALIBRATION_SUPPORTED | passes_all_gates |
| Josh Hart | reb | UNDER | 7.500 | fanduel | 0.574 | 0.427 | +0.147 | +0.319 | ACTIONABLE_REVIEWED | market_prob_disagreement | CALIBRATION_SUPPORTED | passes_all_gates |
...
| Dylan Harper | ast | UNDER | 2.500 | betparx | 0.592 | 0.454 | +0.139 | +0.302 | ACTIONABLE_REVIEWED | market_prob_disagreement | CALIBRATION_SUPPORTED | passes_all_gates |
| Devin Vassell | reb | UNDER | 4.500 | fanduel | 0.699 | 0.563 | +0.137 | +0.217 | ACTIONABLE_REVIEWED | line_vs_median_gap | CALIBRATION_SUPPORTED | passes_all_gates |
| Victor Wembanyama | ast | UNDER | 2.500 | betway | 0.539 | 0.404 | +0.136 | +0.293 | ACTIONABLE_REVIEWED | market_prob_disagreement | CALIBRATION_SUPPORTED | passes_all_gates |
| Karl-Anthony Towns | reb | UNDER | 11.500 | draftkings | 0.650 | 0.522 | +0.129 | +0.215 | ACTIONABLE_REVIEWED | line_vs_median_gap | CALIBRATION_SAMPLE_LIMITED | passes_all_gates; calibration sample limited (n=30) |
...
| Karl-Anthony Towns | ast | OVER | 3.500 | betrivers | 0.701 | 0.575 | +0.126 | +0.192 | ACTIONABLE_REVIEWED | line_vs_median_gap | CALIBRATION_SUPPORTED | passes_all_gates |
| Julian Champagnie | pts | UNDER | 10.500 | fanduel | 0.590 | 0.499 | +0.093 | +0.152 | ACTIONABLE_REVIEWED | line_vs_median_gap | NOT_CHECKED | passes_all_gates |
