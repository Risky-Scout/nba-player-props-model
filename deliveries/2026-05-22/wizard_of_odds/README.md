...
- **tov_status**: `present`
- **row counts**: fair_odds_board=3341, full_pmfs_wide=156, market_comparison=2159, publishable_edges=1668
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 403, 'fair_under_odds_null_count': 403, 'zero_or_one_prob_count': 260}`
