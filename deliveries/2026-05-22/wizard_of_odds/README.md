...
## Run status — 2026-05-22 — snapshot `morning`
...
- **tov_status**: `present`
- **row counts**: fair_odds_board=3341, full_pmfs_wide=156, market_comparison=2239, publishable_edges=1729
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 431, 'fair_under_odds_null_count': 431, 'zero_or_one_prob_count': 260}`
