...
- **tov_status**: `present`
- **row counts**: fair_odds_board=3084, full_pmfs_wide=144, market_comparison=2351, publishable_edges=1891
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 673, 'fair_under_odds_null_count': 673, 'zero_or_one_prob_count': 671}`
