...
- **tov_status**: `present`
- **row counts**: fair_odds_board=3084, full_pmfs_wide=144, market_comparison=2338, publishable_edges=1929
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 650, 'fair_under_odds_null_count': 650, 'zero_or_one_prob_count': 647}`
