# Derek PMF Snapshots — May 7, 2026
...
_Game ID `21708301` (used in paths only). Tip time UTC: ``._

- **T-minus-25**: Pending dispatch
- **Close-lock** (Available):
  - [snapshot_report.md](21708301/close_lock/snapshot_report.md)
  - [market_comparison.csv](21708301/close_lock/market_comparison.csv)

### Cavaliers @ Pistons

_Game ID `21709223` (used in paths only). Tip time UTC: ``._

- **T-minus-25**: Pending dispatch
- **Close-lock** (Available):
  - [snapshot_report.md](21709223/close_lock/snapshot_report.md)
  - [market_comparison.csv](21709223/close_lock/market_comparison.csv)
