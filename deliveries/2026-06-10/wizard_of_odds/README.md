...
## Run status — 2026-06-10 — snapshot `morning`
...
- **tov_status**: `present`
- **row counts**: fair_odds_board=3855, full_pmfs_wide=180, market_comparison=2775, publishable_edges=2161
- **fair_odds_board diagnostics**: `{'fair_over_odds_null_count': 821, 'fair_under_odds_null_count': 821, 'zero_or_one_prob_count': 815}`
