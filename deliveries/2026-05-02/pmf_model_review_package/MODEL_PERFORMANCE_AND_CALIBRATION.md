# Model performance & calibration — 2026-05-02

**after_game_status**: `pending_outcomes`

This file will be re-written by `scripts/score_daily_pmf_delivery_after_game.py` once box-score finals are loaded into `data/player_game_stats.parquet` for 2026-05-02.

## Rollup at delivery time

- delivery_date: `2026-05-02`
- props in delivery: **29**
- finality_status: `provisional`
- finality_blockers: lineup_unconfirmed, missing_stats:tov
- model_version: `555f92a#phase10c`
