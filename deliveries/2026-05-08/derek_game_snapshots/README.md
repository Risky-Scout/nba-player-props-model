...
_Game ID `21708677` (used in paths only). Tip time UTC: `2026-05-08T23:10:00Z`._

- **T-minus-25** (Missed during setup window; documented, not backfilled):
  - [missed_snapshot_report.md](21708677/t_minus_25/missed_snapshot_report.md)
- **Close-lock** (Missed during setup window; documented, not backfilled):
  - [missed_snapshot_report.md](21708677/close_lock/missed_snapshot_report.md)
