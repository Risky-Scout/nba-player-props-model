...
- **role_freshness_status (rollup)**: `{'derived_from_projected_minutes': 340}`
- **tov_status**: `present`
- **row counts**: fair_odds_board=7956, full_pmfs_wide=340, market_comparison=2274, publishable_edges=1578
