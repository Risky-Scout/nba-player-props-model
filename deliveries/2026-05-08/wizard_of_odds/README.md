...
## Run status — 2026-05-08 — snapshot `morning`
...
- **tov_status**: `present`
- **row counts**: fair_odds_board=7839, full_pmfs_wide=335, market_comparison=1639, publishable_edges=1111
